  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: CircleAvatar(
            ...
            child: IconButton(
              icon: const Icon(Icons.arrow_back, color: AppColors.darkerPrimaryColor),
              onPressed: () {
        ...
        actions: [
          Padding(
            ...
            child: CircleAvatar(
              backgroundColor: AppColors.whitePurple.withOpacity(0.7),
              child: IconButton(
                icon: const Icon(Icons.share, color: AppColors.darkerPrimaryColor),
                onPressed: () {},
              ),
            ),
          ),
          Padding(
            ...
            child: CircleAvatar(
              backgroundColor: AppColors.whitePurple.withOpacity(0.7),
              child: IconButton(
                icon: const Icon(Icons.favorite_border, color: AppColors.darkerPrimaryColor),
                onPressed: () {},
              ),
            ),
          ),
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ClipRRect( // ClipRRect added here
                  ...
                  ListView(
                    ...
                    children: [
                      CardCourtWidgets(
                        title: 'Swimming Pool',
                        price: 'Rp 35.000/hr',
                        imagePaths: const ['assets/images/venue_dummy.png'],
                        onBook: () {
                          print('Booked');
                        },
                      ),
